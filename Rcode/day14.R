...
View(mpg)
boxplot(mpg$hwy, notch=T) # , notch=T 중앙값을 눈에 잘 띄게 나타내줌
...
sketch + geom_point(aes(color=drv)) # color를 drv 변수별로 다르게 하고 싶으면 aes()안에 포함 시켜서 수행해줘야 한다.
